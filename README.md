...
אפליקציה לניהול תורנויות אירוח תלמידים בכיתה. כל תלמיד מארח בדיוק פעם אחת במחזור, והאפליקציה עובדת גם ללא חיבור לאינטרנט.
...
- לחץ על "הוסף תלמידים"
- הזן או הדבק רשימת שמות (שורה אחת לכל תלמיד)
- לחץ "שמור"
...
### שלב 4: יצירת תוכנית
- לחץ על "תכנון" בתפריט
- לחץ על "צור תוכנית" (במצב "יוצר קבוצות מפגש")
- האפליקציה תחשב אוטומטית מי מארח בכל סיבוב
- לאחר יצירת התוכנית, תוכל לעבור בין מצבי תצוגה שונים:
  - **יוצר קבוצות מפגש**: יצירת תוכנית חדשה
  - **לוח מפגשים**: תצוגה אינטראקטיבית עם אפשרות שינויים
  - **תצוגה ברשימה**: תצוגת טבלה מפורטת
  - **שיתוף**: שיתוף, הדפסה וגיבוי

### שלב 5: שיתוף התוכנית
- לחץ על "שיתוף" במצבי התצוגה של התכנון
...
### יצירת תוכנית חכמה
**יוצר קבוצות מפגש (מצב יצירת מפגש)**
...
- כפתור "בטל מעבר אחרון" לביטול שינויים
- כפתור "בטל בחירה" לביטול בחירת תלמיד
...
### מערכת אימות
**פאנל אימות (במצב לוח מפגשים)**
- מופיע בתוך לוח המפגשים לאחר יצירת התוכנית
- מציג שגיאות ואזהרות בזמן אמת
...
**תיקון אוטומטי**
- כפתור "ניסיון תיקון" לתקן בעיות אוטומטית
- האפליקציה מנסה לתקן בעיות פשוטות בעצמה

### שיתוף וייצוא
**מצב שיתוף (בתכנון)**
- נגיש דרך כפתור "שיתוף" במצבי התצוגה של התכנון
- כולל את כל אפשרויות השיתוף והגיבוי במקום אחד
...
- **מקסימום**: 15 תלמידים (לא כולל המארח)
...
✅ **קל לשימוש** - ממשק נקי ואינטואיטיבי  
